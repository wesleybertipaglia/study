class Game {
    ...
    defineButtons() {
        ...
        this.layout.previousButton.addEventListener('click', this.previousQuestion);
    ...
    displayButtons() {
        ...
        } else if (this.currentQuestionIndex > 0 && this.currentQuestionIndex < this.questions.length - 1) {
